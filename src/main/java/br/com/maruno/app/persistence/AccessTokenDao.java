...
public interface AccessTokenDao extends JpaRepository<AccessToken, String> {
	...
	@Query(value =  
		"\n SELECT TOKEN.* " + 
		"\n FROM "+Domain.SCHEMA+".TB_ACCES_TOKEN TOKEN" + 
		"\n" + 
		"\n  INNER JOIN "+Domain.SCHEMA+".TB_USUARIO USUARIO ON USUARIO.COD_USUARIO = TOKEN.COD_USUARIO  " + 
		"\n  INNER JOIN "+Domain.SCHEMA+".TB_PERFIL PERFIL ON PERFIL.COD_PERFIL = USUARIO.COD_PERFIL " + 
		"\n  INNER JOIN "+Domain.SCHEMA+".RL_PERFIL_RECURSO RL_RECURSO ON RL_RECURSO.COD_PERFIL = PERFIL.COD_PERFIL " + 
		"\n  INNER JOIN "+Domain.SCHEMA+".TB_RECURSO RECURSO ON RECURSO.COD_RECURSO = RL_RECURSO.COD_RECURSO " + 
		"\n" + 
